...
The first step in attempting to forecast inflation is correctyl defining our data. Data has been downloaded from FRED, with the variables singled out being TCU,MICH,UNRATE,PCEPI, and IPMAN.
